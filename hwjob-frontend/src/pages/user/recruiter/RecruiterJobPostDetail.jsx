...
import ApplicantListAIFilterSection from "../../../components/sections/recruiter/jobPostDetail/ApplicantListAIFilterSection";

const JOB_POST_MANAGEMENT_MENUS = [
  { key: "desc", label: "Mô tả chung" },
  { key: "applicantList", label: "Ứng viên đã nộp" },
  { key: "ai", label: "Lọc ứng viên AI" },
      ...
      <div className="">
        <TabGroup>
          ...
          <TabPanels className="bg-white rounded-2xl p-5 mt-3 ">
            ...
            <TabPanel>
              <ApplicantListAIFilterSection jobPost={jobPost} />
            </TabPanel>
            <TabPanel>
