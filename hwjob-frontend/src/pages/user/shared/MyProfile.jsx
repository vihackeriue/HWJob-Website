...
import RatingSection from "../../../components/sections/profile/RatingSection.jsx";
...
const MyProfile = () => {
  ...
  if (loading || !myInfo) return <Loading />;
    ...
    <TabGroup>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 my-5">
        <div className="flex flex-col gap-3 col-span-1">
          ...
          <MenuTabListVertical menus={PROFILE_USER_MENU} title={"Quản lý"} />
        </div>
        <TabPanels className="col-span-2  flex flex-col gap-3 ">
          ...
          <TabPanel>
            <UpdateInfoSection personalInfo={myInfo} onUpdated={refetch} />
          </TabPanel>
          <TabPanel>
            <RatingSection />
          </TabPanel>
