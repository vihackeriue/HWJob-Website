...
const UpdateJobPostDialog = ({ open, onClose, onUpdate, jobPost }) => {
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 flex flex-col gap-2 bg-white p-3 rounded-2xl ">
              ...
              <FormSelect
                label="Loại nghề"
                name="jobTypeId"
                selected={jobTypes.data.find(
                  (j) => j.id === formJobPost.jobTypeId
                )}
                onChange={handleChange}
              ...
              <FormSelect
                label="Khu vực"
                name="regionId"
                selected={regions.data.find(
                  (r) => r.id === formJobPost.regionId
                )}
                onChange={handleChange}
              ...
              <div className="flex justify-end gap-3 mt-5">
                ...
                <PrimaryButton onClick={handleSubmit}>Cập nhật</PrimaryButton>
              </div>
            </div>
          </div>
        </DialogPanel>
